...
exports.default = FootNoteEditor;
...
var _excluded = ["htmlPerf", "onHtmlPerf", "sequenceIds", "sequenceId", "addSequenceId", "options", "components", "handlers"];
...
function FootNoteEditor(_ref) {
  ...
  var onBlockClick = (0, _react.useCallback)(function (_ref3) {
    ...
    console.log(_sequenceId); // addSequenceId(_sequenceId);
  }, []);
