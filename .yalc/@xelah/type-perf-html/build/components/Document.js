...
var _excluded = ["nodes", "children", "content", "className", "verbose"];
...
function Document(_ref) {
  ...
  var _nodes$sequence = nodes.sequence(),
      dataset = _nodes$sequence.dataset,
      className = _nodes$sequence.className;

  return /*#__PURE__*/_react.default.createElement("section", _extends({
    id: "sequence",
    className: "".concat(className, " ").concat(_className)
  }, dataset), children);
}
